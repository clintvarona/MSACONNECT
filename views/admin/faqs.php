...
<div class="admin-container">
    <div class="admin-page-header">
        <h3><strong>FAQs Management</strong></h3>
        <button class="admin-btn admin-btn-add" onclick="openFaqModal('addEditFaqModal', null, 'add')">
                ...
                <?php if ($faqs): 
                    ...
                    <?php foreach ($faqs as $faq): ?>
                        <tr data-id="<?= $faq['faq_id'] ?>">
                            ...
                            <td>
                                <button class="admin-btn admin-btn-edit btn-sm" onclick="openFaqModal('addEditFaqModal', <?= $faq['faq_id'] ?>, 'edit')">
                                    <i class="bi bi-pencil"></i>
                                </button>
                                <button class="admin-btn admin-btn-delete btn-sm" onclick="openFaqModal('deleteFaqModal', <?= $faq['faq_id'] ?>, 'delete')">
