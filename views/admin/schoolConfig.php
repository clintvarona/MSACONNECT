...
<div class="admin-container">
    <div class="admin-page-header">
        ...
        <button class="admin-btn admin-btn-add" onclick="openCollegeModal('addEditCollegeModal', null, 'add')">
                ...
                <?php if ($colleges):
                    ...
                    <?php foreach ($colleges as $college): ?>
                        <tr>
                            ...
                            <td>
                                <button class="admin-btn admin-btn-edit btn-sm" onclick="openCollegeModal('addEditCollegeModal', <?= $college['college_id'] ?>, 'edit')">
                                    <i class="bi bi-pencil"></i>
                                </button>
                                <button class="admin-btn admin-btn-delete btn-sm" onclick="openCollegeModal('deleteCollegeModal', <?= $college['college_id'] ?>, 'delete')">
