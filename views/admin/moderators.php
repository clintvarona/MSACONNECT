...
<div class="admin-container">
    <div class="admin-page-header">
        ...
        <button class="admin-btn admin-btn-add" onclick="openModeratorModal('addModeratorModal', null, 'add')">
                ...
                <?php if ($result): 
                    ...
                    <?php foreach ($result as $row): ?>
                        <tr>
                            ...
                            <td>
                                <button class="admin-btn admin-btn-edit btn-sm" onclick="openModeratorModal('editModeratorModal', <?= $row['user_id'] ?>, 'edit')">
                                    <i class="bi bi-pencil"></i>
                                </button>
                                <button class="admin-btn admin-btn-delete btn-sm" onclick="openModeratorModal('deleteModeratorModal', <?= $row['user_id'] ?>, 'delete')">
