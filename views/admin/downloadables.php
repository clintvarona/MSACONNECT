...
<div class="admin-container">
    <div class="admin-page-header">
        ...
        <button class="admin-btn admin-btn-add" onclick="openFileModal('addEditFileModal', null, 'add')">
                ...
                <?php if ($downloadableFiles): ?>
                    ...
                    <?php foreach ($downloadableFiles as $file): ?>
                        <tr>
                            ...
                            <td><?= $adminObj->getFileExtension(clean_input($file['file_type'])) ?></td>
                            <td><span class="file-size"><?= formatFileSize($file['file_size']) ?></span></td>
                            <td><?= clean_input($file['username']) ?></td>
                            <td><?= formatDate($file['created_at']) ?></td>
                            <td>
                                <button class="admin-btn admin-btn-edit btn-sm" onclick="openFileModal('addEditFileModal', <?= $file['file_id'] ?>, 'edit')">
