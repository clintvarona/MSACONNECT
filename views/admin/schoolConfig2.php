...
<div class="admin-container">
    <div class="admin-page-header">
        ...
        <button class="admin-btn admin-btn-add" onclick="openProgramModal('addEditProgramModal', null, 'add')">
                ...
                <?php if ($programs):
                    ...
                    <?php foreach ($programs as $program): ?>
                        <tr>
                            ...
                            <td>
                                <button class="admin-btn admin-btn-edit btn-sm" onclick="openProgramModal('addEditProgramModal', <?= $program['program_id'] ?>, 'edit')">
                                    <i class="bi bi-pencil"></i>
                                </button>
                                <button class="admin-btn admin-btn-delete btn-sm" onclick="openProgramModal('deleteProgramModal', <?= $program['program_id'] ?>, 'delete')">
