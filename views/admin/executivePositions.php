...
<head>
    ...
    <style>
        ...
        /* DataTables styling - same as colleges page */
...
<div class="admin-container">
    <div class="admin-page-header">
        <h3><strong>Executive Positions</strong></h3>
        <button class="admin-btn admin-btn-add" onclick="openPositionModal('editExePositionModal', null, 'add')">
                ...
                <?php if ($positions): ?>
                    ...
                    <?php foreach ($positions as $position): ?>
                        <tr>
                            ...
                            <td>
                                <button class="admin-btn admin-btn-edit btn-sm" onclick="openPositionModal('editExePositionModal', <?= $position['position_id'] ?>, 'edit')">
                                    <i class="bi bi-pencil"></i>
                                </button>
                                <button class="admin-btn admin-btn-delete btn-sm" onclick="openPositionModal('archiveExePositionModal', <?= $position['position_id'] ?>, 'delete')">
